...
<head>
    ...
    <title>Login - Gadget Online Store</title>
...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card p-4">
                    <h2 class="text-center neon-text" style="color:white;">Login</h2>
                    ...
                    <p style="color:white;" class="text-center mt-3">Belum punya akun? <a href="register.php" class="text-decoration-none" style="color:rgb(255, 6, 122);">Daftar</a></p>
